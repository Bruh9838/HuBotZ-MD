...
const getStatusModels = async (query) => {
...
const HuggingFace = async (MODEL, INPUT) => {
...
const HuggingFaceBuffer = async (MODEL, INPUT) => {
  const apiUrl = `${BASE_URL}${MODEL}`;
  const fetchOptions = {
    method: 'POST',
    headers: {
...
module.exports = { getStatusModels, HuggingFace, HuggingFaceBuffer }
